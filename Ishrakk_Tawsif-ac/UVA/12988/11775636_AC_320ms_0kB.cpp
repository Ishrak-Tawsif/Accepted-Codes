...
int checkraw(int i,int j,int k,int l)
{
    ...
    for(int a=0; a<4; a++)
    {
        ...
        /*if(i==1 && j==3&&k==4&&l==2) for(int ii=1; ii<=4; ii++) cout<<ii<<" "<<click[ii]<<" ";
        cout<<endl<<fl;
        cout<<endl;*/
    }
    return fl;
...
int checksqr(int i,int j,int k,int l)
{
    ...
    /*for(int i=0; i<4; i++)
    {
        for(int j=0; j<4; j++) cout<<temp[i][j];
        cout<<endl;
    }*/
            ...
            for(int j=1; j<=24; j++)
            {
                ...
                for(int k=1; k<=24; k++)
                {
                    ...
                    for(int l=1; l<=24; l++)
                    {
                        ...
                        ///checking
                        thikase = 1;//out(i);
                        //if(i == 2 && j == 23 && k == 18 && l == 7)cout<<"i'm in\n";
                        int inwhich;
                        for(int konta=0; konta<4; konta++)
                        {
                            ...
                            for(int a=0; a<4; a++)
                            {
                                ...
                                if(str[konta][a] != '*')
                                {/*if(i == 17 && j == 1 && k == 10 && l == 19){
                                    cout<<inwhich<<" .."<<" "<<konta<<endl;
                                    cout << str[konta][a]<<" "<< vv[inwhich][a]<<endl;
                                }*/
                                    if((str[konta][a]-'0') != vv[inwhich][a]) {thikase = 0;break;}
                                }
                            }
                        }//if(i == 2 && j == 23 && k == 18 && l == 7)cout<<"thikase "<<thikase<<endl;
