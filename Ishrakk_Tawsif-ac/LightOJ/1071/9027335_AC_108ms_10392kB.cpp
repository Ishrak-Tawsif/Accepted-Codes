...
ll call(int r1,int c1,int r2, int c2)
{
    ...
    if(dp[r1][c1][c2] != -1) return dp[r1][c1][c2];
        ...
        ll ans = LONG_MIN;
            ...
            ans = call(r1+1,c1,r2+1,c2);
            ans = max(ans,call(r1+1,c1,r2,c2+1));
            ans = max(ans,call(r1,c1+1,r2+1,c2));
            ans = max(ans,call(r1,c1+1,r2,c2+1));
    return dp[r1][c1][c2] = ans + arr[r1][c1] + arr[r2][c2];
}
